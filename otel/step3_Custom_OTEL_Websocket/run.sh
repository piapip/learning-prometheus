...
#   ./prometheus --config.file=/home/piapip/Desktop/Tutorial/prometheus/otel/step3_Custom_OTEL_Websocket/docker/prometheus.yml

OTEL_RESOURCE_ATTRIBUTES="service.name=dice,service.version=0.1.0" go run ./otel/step3_Custom_OTEL_Websocket/main.go
